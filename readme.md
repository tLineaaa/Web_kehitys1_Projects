...
DOM-skriptaus (projekti 1), Taru Laine
...
Kuvakaappaukset
Vähintään yksi kuvakaappaus toimivasta sovelluksesta
...
...
Kiitokset
Hyödynsin projektin teossa Laurean Web-kehitys 1 (front end)-kurssin kurssimateriaalia Lista lähteistä ja esimerkeistä, joita käytit projektin aikana. Mainitse myös, jos käytit ChatGPT:tä tai muita tekoälytyökaluja koodauksen aikana ja kerro, miten ne auttoivat sinua.
